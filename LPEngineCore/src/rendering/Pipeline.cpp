...
namespace LPEngine
{
	...
	std::vector<char> Pipeline::readFile(const std::string& path)
	{
		...
		if (!file.is_open())
		{
			Logger::Log(LogLevel::ERROR, "Failed to open file: ", path);
	...
	void Pipeline::createGraphicsPipeline(const std::string& vertPath, const std::string& fragPath, const PipelineConfigInfo& configInfo)
	{
		...
		{
			Logger::Log(LogLevel::INFO, "Successfully created graphics pipeline");
		}
	}
	...
	void Pipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule)
	{
		...
		{
			Logger::Log(LogLevel::ERROR, "Failed to create shader module");
		}
		else
		{
			Logger::Log(LogLevel::INFO, "Successfully created shader module");
		}
	}
