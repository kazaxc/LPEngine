...
namespace LPEngine
{
	...
	void Device::createInstance()
	{
		...
		appInfo.pApplicationName = "LPEngine";
		appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
		appInfo.pEngineName = "LPEngine";
	...
	void Device::pickPhysicalDevice()
	{
		...
		Logger::Log(LogLevel::INFO, "selected device: ", properties.deviceName);
	}
	...
	std::vector<const char*> Device::getRequiredExtensions()
	{
		...
		SDL_Vulkan_GetInstanceExtensions(window.GetWindow(), &extensionCount, extensionNames);
	...
	void Device::hasRequiredInstanceExtensions()
	{
		...
		Logger::Log(LogLevel::INFO, "Available Extensions:");
		std::unordered_set<std::string> available;
		for (const auto& extension : extensions)
		{
			Logger::Log(LogLevel::INFO, "\t", extension.extensionName);
			available.insert(extension.extensionName);
		}

		Logger::Log(LogLevel::INFO, "Required Extensions:");
		auto requiredExtensions = getRequiredExtensions();
		for (const auto& required : requiredExtensions)
		{
			Logger::Log(LogLevel::INFO, "\t", required);
